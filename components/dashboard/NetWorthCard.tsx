...
import { formatCurrency } from "@/utils/formatters"; // <-- Imported your new utility!
...
// Mock data to generate the curve seen in the wireframe
const mockTrendData = [
  { value: 32000 }, { value: 31000 }, { value: 35000 }, 
  { value: 34000 }, { value: 42000 }, { value: 39000 }, 
  { value: 48250 }
];
...
export default function NetWorthCard({ netWorth = 0, percentageChange = 0 }: NetWorthCardProps) {
  ...
  // 1. Replaced the raw Intl.NumberFormat with your clean utility function
