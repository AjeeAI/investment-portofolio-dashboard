...
/**
 * PageSkeleton provides a visual placeholder for the dashboard layout.
 * Used during the initial data fetching phase to prevent layout shift.
 */
    ...
    <div className="min-h-screen bg-[var(--color-trove-page-bg)] flex flex-col md:flex-row w-full">
      ...
      <main className="flex-1 flex flex-col max-w-7xl mx-auto w-full">
        ...
        <div className="p-8 flex flex-col gap-8 w-full">
          ...
          {/* Row 2: Account List Cards (The missing piece!) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-[var(--color-trove-card-surface)] border border-[var(--color-trove-border)] rounded-[var(--radius-trove-card)] p-5 shadow-sm">
                <div className="h-4 w-20 bg-[var(--color-trove-border)] rounded animate-pulse mb-3"></div>
                <div className="h-6 w-24 bg-[var(--color-trove-border)] rounded animate-pulse mb-1"></div>
